...
<body>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <?php if(Auth::check() && Session::has('proceso_tipo')):?>
        <ul class="nav navbar-nav" id="menu-superior">
            ...
            <?php if(Session::get('proceso_tipo')=='ejercicio' || Session::get('proceso_tipo')=='evaluacion'): ?>
                <li <?=Request::is('controles') ? 'class="active"' : '' ?>><a href="<?=URL::to('controles')?>">Controles</a></li>
            <?php endif; ?>
            <?php if(Session::get('proceso_tipo')=='ejercicio' || Session::get('proceso_tipo')=='formulacion'): ?>
                <li <?=Request::is('riesgos') ? 'class="active"' : '' ?>><a href="<?=URL::to('riesgos')?>">Análisis de riesgo</a></li>
            <?php endif; ?>
            <?php if(Session::get('proceso_tipo')=='ejercicio'): ?>
